...
5. **Build and Run Your Service Natively:**
...
6. **Optionally Use XDS:**
   Optionally use the AGL XCross Development System (XDS) to cross-compile
   and port your binding to actual target hardware.

7. **Optionally Use CANdevStudio:**
   Optionally use the Controller Area Network (CAN) Development Studio
   (CANdevStudio) to simulate signals across a CAN bus.
